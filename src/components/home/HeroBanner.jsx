...
export default function HeroBanner() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950 pt-16">
      ...
      <div className="absolute top-16 left-0 w-full bg-amber-500/10 border-b border-amber-500/20 py-1.5 overflow-hidden z-30 pointer-events-none">
      ...
      <div className="relative z-40 max-w-5xl mx-auto px-6 text-center mt-8">
        ...
        >
          ...
          <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full border border-amber-500/30 bg-black/20 backdrop-blur-xl mb-10 shadow-[0_0_30px_rgba(245,158,11,0.15)] hover:bg-black/40 transition-colors">
